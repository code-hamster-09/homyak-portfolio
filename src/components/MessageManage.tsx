...
import Pusher from "pusher-js"; // Импорт Pusher-клиента
          ...
          {selectedMessage ? (
            <div className="space-y-4 relative">
              ...
              <button
                ...
                className="text-red-500 px-2 py-1 hover:-translate-y-0.5 hover:text-gray-400 hover:bg-white/10 rounded-xl cursor-pointer transition-all duration-300 absolute top-0 right-0 m-0"
              >
